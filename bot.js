...
var _this = this;
var sdk = require("matrix-bot-sdk");
...
client.on("room.message", function (roomId, event) { return __awaiter(_this, void 0, void 0, function () {
    var sender, body;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, client.sendMessage(roomId, { msgtype: "m.notice", body: "how can I help you?" })];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
